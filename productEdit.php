    ...
    if (in_array($fileActualExtension, $allowedExtensions)) {
        if ($fileError === 0) {
            ...
            if ($fileSize < 10000000000) {
                ...
                $sql = "UPDATE Product SET ProductName= :newProdName, Category= :newProdCategory, Quantity= :newProdQuantity, ProductPrice= :newProdPrice, Image= :newProdImage, Code= :newProdCode WHERE code='$prodCode'";
